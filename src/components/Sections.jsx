    ...
    <footer className="border-t border-line bg-midnight pt-14 pb-8 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-extrabold flex items-center gap-2"><img src={`${import.meta.env.BASE_URL}images/logo.png`} alt="Novus" className="w-10 h-10 rounded-lg object-contain" />No<span className="gradient-text">vus</span></h3>
